...
import 'package:flutter_redux_boilerplate/presentation/widgets/week_day_selector/week_day_selector_theme.dart';
...
void main() {
  ...
  group('$WeekdaySelectorTheme with the $WeekdaySelector(onChanged: null, values: null) widget - not selected',
      () {
